...
fn every_board_request_uses_contracted_snake_case_names() {
    let requests = [
        ...
        serde_json::json!({"type":"ensure_worktree_board","worktree_id":"acme/api#feature"}),
        serde_json::json!({"type":"create_board","context_id":"work","name":null,"prefix":null,"backend":null}),
        serde_json::json!({"type":"create_worktree_board","worktree_id":"acme/api#feature","name":null,"prefix":null,"backend":null}),
