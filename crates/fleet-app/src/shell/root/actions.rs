...
impl Shell {
    ...
    pub(super) fn with_actions(
        ...
        .on_action(cx.listener(Self::board_attach_run))
        .on_action(cx.listener(Self::board_cancel_run))
        .on_action(cx.listener(Self::board_run_now))
        .on_action(cx.listener(Self::board_pick_blocked_by))
        .on_action(cx.listener(Self::board_pick_agent))
        .on_action(cx.listener(Self::board_columns))
        .on_action(cx.listener(Self::board_schedules))
        .on_action(cx.listener(Self::board_run_schedules))
        .on_action(cx.listener(Self::board_open_pull_request))
        .on_action(cx.listener(Self::board_copy_pull_request_url))
